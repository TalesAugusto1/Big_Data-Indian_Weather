...
| Data | Slug | Resumo |
|------|------|--------|
| 2026-05-02 | [m03-t031-decision-tree-notebook-robustness](2026-05-02-m03-t031-decision-tree-notebook-robustness.md) | M03 / T031: `setuptools` no `requirements.txt`; notebook `decision_tree.ipynb` — JAVA_HOME/SPARK_MASTER, reset Py4J após crash, memória driver local, `coalesce` vs shuffle, menos OOM/gateway no host |
